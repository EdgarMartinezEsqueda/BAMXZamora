import { FaAppleAlt, FaArrowRight, FaBoxes, FaPeopleCarry, FaTruck, FaUserCheck, FaWarehouse } from "react-icons/fa";
  ...
  const processItems = [
    {
      ...
      description: "Recibimos donaciones de empresas, particulares y programas gubernamentales",
      color: "from-red-500 to-red-600",
      bgColor: "bg-red-50",
      borderColor: "border-red-200",
      stats: "50+ toneladas/mes"
    },
    {
      icon: <FaBoxes />,
      number: "02", 
      title: "Clasificación y Selección",
      description: "Revisamos y clasificamos todos los alimentos para garantizar su calidad",
    ...
    },
    {
      ...
      description: "Guardamos los alimentos en condiciones óptimas hasta su distribución",
      color: "from-green-500 to-green-600",
      bgColor: "bg-green-50",
      borderColor: "border-green-200",
      stats: "Capacidad 200 ton"
    },
    {
      icon: <FaPeopleCarry />,
      number: "04",
      title: "Preparación de Despensas",
      description: "Nuestros voluntarios arman despensas equilibradas para cada familia",
      color: "from-red-500 to-red-600",
      bgColor: "bg-red-50",
      borderColor: "border-red-200",
      stats: "9,000+ despensas/mes"
    },
    {
      icon: <FaTruck />,
      number: "05",
      title: "Distribución",
      description: "Llevamos las despensas a 14 municipios de Los Altos de Jalisco",
    ...
    },
    {
      ...
      description: "Monitoreamos el impacto y el bienestar de las familias beneficiadas",
      color: "from-yellow-500 to-yellow-600",
      bgColor: "bg-yellow-50",
      borderColor: "border-yellow-200",
      stats: "Seguimiento continuo"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Desde la recepción de alimentos hasta su entrega a quienes más lo necesitan, cada paso es clave para combatir el hambre en Los Altos de Jalisco
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
            {processItems.map((item, index) => (
              <div
                key={index}
                className={`group relative ${index % 2 === 0 ? 'lg:justify-self-end lg:text-right' : 'lg:justify-self-start lg:text-left'}`}
                style={{
              ...
              >
                ...
                <div className={`relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border ${item.borderColor} hover:border-opacity-60 transform-gpu will-change-transform backface-hidden perspective-1000`}>
                  ...
                  <div className="flex items-start gap-6 mb-6">
                    <div className={`relative flex-shrink-0 w-20 h-20 bg-gradient-to-br ${item.color} rounded-2xl flex items-center justify-center text-white shadow-lg transition-all duration-300 transform-gpu will-change-transform`}>
          ...
          <div className="bg-gradient-to-r from-green-500/5 via-yellow-500/5 to-red-500/5 rounded-3xl p-8 md:p-12 border border-green-500/10">
            <div className="text-center max-w-4xl mx-auto space-y-6">
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-gray-800">
                Un proceso eficiente que transforma vidas
              </h3>
              
              <p className="text-gray-600 text-lg leading-relaxed">
                Cada mes, nuestro proceso estructurado nos permite entregar más de 9,000 despensas a familias necesitadas en 14 municipios, garantizando que cada alimento llegue en perfectas condiciones.
              </p>

              {/* Estadísticas destacadas */}
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-8">
                <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/50">
                  <div className="text-3xl font-black text-green-500 mb-2">50+</div>
                  <div className="text-gray-700 font-semibold text-sm">Toneladas/mes</div>
                </div>
                <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/50">
                  <div className="text-3xl font-black text-yellow-500 mb-2">100%</div>
                  <div className="text-gray-700 font-semibold text-sm">Verificados</div>
                </div>
                <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/50">
                  <div className="text-3xl font-black text-red-500 mb-2">9K+</div>
                  <div className="text-gray-700 font-semibold text-sm">Despensas</div>
                </div>
                <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/50">
